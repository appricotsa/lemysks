...
<head>
    <base href="../../">
    <meta charset="utf-8" />
    <title>{{ isset($page_title) ? $page_title : 'Sniffer' }}</title>
    ...
    <link href="{{ asset("backend/") }}/css/pages/nestable.css" rel="stylesheet" type="text/css" />
...
<body id="kt_body"
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
        ...
        <a href="{{ route('admin.dashboard') }}">
            <img style="width: 34px; height:34px" alt="Logo" src="{{ asset('backend/') }}/media/logos/logo-1.png" />
        </a>
        <!--end::Logo-->
        <!--begin::Toolbar-->
    ...
    <!--end::Header Mobile-->
    <div id="beginnerContainer" class="d-flex flex-column flex-root">
        <!--begin::Page-->
            ...
            <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                ...
                <div class="brand flex-column-auto" id="kt_brand">
                    ...
                    <a href="index.html" class="brand-logo">
                        <!--<img alt="Logo" style="width: 34px; height:34px"
                            src="{{ asset('backend/') }}/media/logos/benzinlik-logo.jpeg" />-->
                    </a>
                    <!--end::Logo-->
                    <!--begin::Toggle-->
                ...
                <!--end::Brand-->
                @include('backend.modules.sidenav')
            </div>
            <!--end::Aside-->
            <!--begin::Wrapper-->
                        ...
                        <div class="topbar ml-auto">
                            ...
                            <div class="topbar-item">
                                <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2"
                                    ...
                                    <span
                                        class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">AAA</span>
                                    <span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
                                        <span class="symbol-label font-size-h5 font-weight-bold">DDD</span>
                                    </span>
                                </div>
                            </div>
                            <!--end::User-->
